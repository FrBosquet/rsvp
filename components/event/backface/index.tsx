...
export const Backface = () => {
  ...
  return (
    ...
    >
      ...
      <p className="px-c20 text-md leading-6 text-zinc-500">
        ¡Estamos deseando que nos acompañéis en nuestra boda!
      </p>
      <p className="font-serif text-xl font-bold uppercase tracking-2xl">
        11.05.2024
      </p>
