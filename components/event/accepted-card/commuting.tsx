...
export const Commuting = ({ visible }: Props) => {
  ...
  return (
    <Wrapper title="transporte" visible={visible}>
      <p className="text-sm">
        Como sabemos que quizás acabáis en condiciones de hacer cualquier cosa
        menos conducir, hemos contratado un servicio de autobuses que os
        garantizará un traslado seguro.
      </p>
      ...
      >
        Cambiar numero de asistentes, alergias o autobus
      </AnimatedButton>
    </Wrapper>
  )
}
