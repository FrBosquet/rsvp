  ...
  return (
    ...
    >
      ...
      <menu className='flex w-full justify-center gap-c100 p-c50'>
        <button className='button-fill-base flex-1 rounded-md bg-right font-serif text-sm font-light uppercase text-zinc-400 transition-all bg-color-emerald hover:button-fill-hover hover:text-zinc-700'>Sí</button>
        <button className='button-fill-base flex-1 rounded-md font-serif text-sm font-light uppercase text-zinc-400 transition-all bg-color-rose hover:button-fill-hover hover:text-zinc-700 '>No</button>
      </menu>
    </Card>
  )
}
